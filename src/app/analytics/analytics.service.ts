...
export class AnalyticsService {
  ...
  get_select_details(empid,term,sem): Observable<any>{
    let uri = `${this.baseurl}get-select-details/${empid}/${term}/${sem}`
    return this.http.get(uri)
  }
  get_faculty_ia_details(fac_id,year,courseCode,section,deptId,terms):Observable<any>{
    let uri = `${this.baseurl}get-faculty-ia-details/${fac_id}/${year}/${courseCode}/${section}/${deptId}/${terms}`
    return this.http.get(uri)
  }
